module.exports=[23786,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(50944),e=a.i(38246),f=a.i(19107),g=a.i(75160),h=a.i(93740);let i=(0,a.i(64831).default)("copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]);var j=a.i(52562);let k=[{key:"dbt_models",label:"dbt model",lang:"sql"},{key:"sql",label:"SQL",lang:"sql"},{key:"tests",label:"Tests",lang:"yaml"},{key:"docs",label:"Docs",lang:"markdown"},{key:"configs",label:"Config",lang:"yaml"}];function l({bundle:a}){let[d,e]=(0,c.useState)("dbt_models"),[f,g]=(0,c.useState)(!1);return(0,b.jsxs)("div",{className:"card-atlas overflow-hidden",children:[(0,b.jsxs)("div",{className:"flex items-center justify-between border-b border-border-hairline px-2",children:[(0,b.jsx)("div",{className:"flex items-center gap-1 overflow-x-auto py-2",children:k.map(a=>(0,b.jsx)("button",{onClick:()=>e(a.key),className:`whitespace-nowrap rounded-full px-3.5 py-1.5 text-[13px] transition-colors ${d===a.key?"bg-bg-alt text-text-heading":"text-text-body hover:text-text-heading"}`,children:a.label},a.key))}),(0,b.jsxs)("button",{onClick:function(){navigator.clipboard.writeText(a[d]),g(!0),setTimeout(()=>g(!1),1500)},className:"mr-2 flex flex-shrink-0 items-center gap-1.5 rounded-full border border-border-hairline-strong px-3 py-1.5 text-[12px] text-text-body-strong transition-colors hover:text-text-heading",children:[f?(0,b.jsx)(j.Check,{className:"h-3.5 w-3.5 text-accent"}):(0,b.jsx)(i,{className:"h-3.5 w-3.5"}),f?"Copied":"Copy"]})]}),(0,b.jsx)("pre",{className:"max-h-[560px] overflow-auto p-6 font-mono-atlas text-[13px] leading-relaxed text-text-body-strong",children:a[d]})]})}var m=a.i(53250);a.s(["default",0,function(){let a=(0,d.useParams)(),[i,j]=(0,c.useState)(null),[k,n]=(0,c.useState)(null);return(0,c.useEffect)(()=>{let b=!1;return(0,m.getArtifacts)(a.runId).then(a=>!b&&j(a)).catch(a=>!b&&n(String(a))),()=>{b=!0}},[a.runId]),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(h.AppSubNav,{crumb:`agents/${a.runId}/artifacts`}),(0,b.jsx)("main",{className:"flex-1 bg-bg-base",children:(0,b.jsxs)("div",{className:"mx-auto max-w-[1000px] px-6 py-10 lg:px-10",children:[(0,b.jsxs)(e.default,{href:`/agents/${a.runId}`,className:"flex items-center gap-1.5 text-[13px] text-text-body transition-colors hover:text-text-heading",children:[(0,b.jsx)(f.ArrowLeft,{className:"h-3.5 w-3.5"})," Back to run"]}),(0,b.jsx)("h1",{className:"mt-3 text-[26px] font-bold text-text-heading",children:"Generated artifacts"}),(0,b.jsx)("p",{className:"mt-1.5 text-[14px] text-text-body",children:"dbt models, SQL, tests, docs and configs produced by this run."}),(0,b.jsxs)("div",{className:"mt-8",children:[k&&(0,b.jsxs)("p",{className:"text-[14px] text-accent",children:["Failed to load artifacts: ",k]}),!i&&!k&&(0,b.jsxs)("div",{className:"flex items-center gap-2 py-10 text-[14px] text-text-body",children:[(0,b.jsx)(g.Loader2,{className:"h-4 w-4 animate-spin"})," Loading artifacts…"]}),i&&(0,b.jsx)(l,{bundle:i})]})]})})]})}],23786)},93740,a=>{"use strict";var b=a.i(87924),c=a.i(38246),d=a.i(50944),e=a.i(71215),f=a.i(19107);let g=[{label:"Control center",href:"/dashboard",icon:e.Image},{label:"Running agents",href:"/agents",icon:e.Image}];a.s(["AppSubNav",0,function({crumb:a}){let e=(0,d.usePathname)();return(0,b.jsxs)("header",{className:"border-b border-border-hairline bg-bg-base",children:[(0,b.jsx)("div",{className:"flex items-center justify-between px-6 py-2 text-[12px] text-text-muted lg:px-10",children:(0,b.jsxs)("span",{className:"font-mono-atlas",children:["/ ",a]})}),(0,b.jsxs)("div",{className:"flex items-center justify-between border-t border-border-hairline px-6 py-3.5 lg:px-10",children:[(0,b.jsxs)("div",{className:"flex items-center gap-6",children:[(0,b.jsxs)(c.default,{href:"/",className:"flex items-center gap-2.5",children:[(0,b.jsx)("span",{className:"flex h-7 w-7 items-center justify-center rounded-full bg-accent text-xs font-bold text-white",children:"A"}),(0,b.jsxs)("span",{className:"text-[14px] font-semibold text-text-heading",children:["Atlas ",(0,b.jsx)("span",{className:"text-accent",children:"AI"})]})]}),(0,b.jsx)("nav",{className:"flex items-center gap-1",children:g.map(a=>{let d=e===a.href,f=a.icon;return(0,b.jsxs)(c.default,{href:a.href,className:`flex items-center gap-2 rounded-full px-3.5 py-1.5 text-[13px] transition-colors ${d?"bg-bg-card text-text-heading":"text-text-body hover:text-text-heading"}`,children:[(0,b.jsx)(f,{className:"h-3.5 w-3.5"}),a.label]},a.href)})})]}),(0,b.jsxs)(c.default,{href:"/",className:"flex items-center gap-1.5 text-[13px] text-text-body transition-colors hover:text-text-heading",children:[(0,b.jsx)(f.ArrowLeft,{className:"h-3.5 w-3.5"}),"Back to site"]})]})]})}])},53250,a=>{"use strict";let b=process.env.NEXT_PUBLIC_API_URL??"",c=b.length>0;async function d(a){let c=await fetch(`${b}${a}`);if(!c.ok)throw Error(`${c.status} ${c.statusText} on ${a}`);return c.json()}async function e(a){return c?d(`/api/requests/${a}/artifacts`):(await h(400),{request_id:a,dbt_models:`-- models/marts/fct_revenue.sql
with orders as (
